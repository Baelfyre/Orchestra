...
- Adds bounded AQ7 legacy-scope applicability classification: the complete AQ7 slice is outside the historical AQ5/PRAI exact inventories, while partial, mixed, and unknown changes remain fail-closed applicable.
...
- Binds verifier-supplied current version context across work units, receipts, decisions, schema, and CLI validation, rejecting stale or mismatched evidence.
- Restricts receipt evidence_layer to the canonical AQ1 vocabulary and keeps runtime, schema, and machine-contract parity fail closed.
...
- Finalizes AQ-3 integrity by binding AQ-1 verifier sources to receipt identities and enforcing declarative/runtime parity for Overseer, Arbiter, and the canonical specialist registry.
