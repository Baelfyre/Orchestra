...
| `scribe` | Documentation, domain narrative, and knowledge traceability | README/changelog/docs; `SPEC_TO_SYSTEM`; `SYSTEM_TO_DOCS`; `RECONCILE`; domain glossary/narrative; requirements traceability; research/capstone documentation; as-built reconstruction; documentation or implementation drift review | architecture, persistence, formal-model, security, QA, UI/UX, governance, or implementation decisions | Documentation execution and traceability owner | source/project evidence plus only the specialist evidence needed to verify unresolved technical facts | Mode 1,Mode 2,Mode 3 |
...
- **scribe**: avoid for architecture, persistence, formal-model, security, QA, UI/UX, governance, implementation, or release-approval decisions; Scribe may document verified outputs from those owners
