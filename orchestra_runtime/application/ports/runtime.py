...
from orchestra_runtime.models import Command, ContextPackage, ExecutionResult, RouteDecision, Skill, ValidationResult

if TYPE_CHECKING:
    from orchestra_runtime.authority import AuthorityDecision, AuthorityProvenance, AuthorityScope, Constraint, TargetSelector
    from orchestra_runtime.capabilities import CapabilityDecision, RuntimeCapabilityGrant, RuntimeCapabilityManifest
    from orchestra_runtime.delegation import DelegationRequest, DelegationResolution
    from orchestra_runtime.lifecycle import LifecycleSignal, LifecycleSnapshot, StructuredTerminalResult
    from orchestra_runtime.coordination import (
        CollaborationSession,
        CoordinationSignal,
        CoordinationValidationResult,
    )
    from orchestra_runtime.specialist_execution import SpecialistExecutionReceipt, SpecialistExecutionRequest
