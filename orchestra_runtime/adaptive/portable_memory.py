...
class PortableMemoryBackend(Protocol):
    """Backend boundary for external portable-memory stores.

    Implementations may validate or stage candidates, but a candidate alone never
    grants permission to write canonical memory or alter Orchestra execution.
    """
