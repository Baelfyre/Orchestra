...
| **Architecture governance intake and adaptive routing** | Extends Conductor with evidence-bound architecture intake, decision-specific capacity routing, and minimum specialist route composition without transferring domain authority. | [Conductor Architecture Governance Intake](skills/conductor/ARCHITECTURE_GOVERNANCE_INTAKE_GUIDE.md) |
| **Governance contract invalidation and minimal re-entry** | Extends The Tuner with declared governance-contract dependencies, clause-sensitive invalidation, finite cycle handling, and smallest-owner re-entry recommendations without direct routing or authority expansion. | [Cross-Specialist Coordination Protocol](docs/routing/CROSS_SPECIALIST_COORDINATION_PROTOCOL.md) |
