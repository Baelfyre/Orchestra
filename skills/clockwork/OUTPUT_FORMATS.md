...
SOURCE_REVISION_OR_CONTRACT_IDENTITY: [sha256:<canonical accepted UIFidelityHandoff content digest>]
...
- [component_ref or evidence_identity | decision | reason; never invent project-native evidence]

INTEGRATION_BOUNDARIES:
- [boundary id | INPUT/OUTPUT | contract | rule]
