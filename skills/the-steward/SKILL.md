...
primary_use: Business alignment validation, scope validation, requirements traceability, product intent validation, capacity envelope review, SDLC documentation completeness, acceptance criteria review
...
Minimum context: Name, Type, Purpose, Target Users, Internal/Public, OSS/Private, Release Stage, Risk Level, Required Documentation. Use [prompt](../../docs/governance/PROJECT_CONTEXT_DECISION_PROMPT.md), [policy](../../docs/governance/PROJECT_CONTEXT_ENFORCEMENT_POLICY.md), and [template](../../docs/templates/PROJECT_CONTEXT_TEMPLATE.md).
