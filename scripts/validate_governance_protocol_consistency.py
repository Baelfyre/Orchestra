...
REQUIRED_RECORD_SCHEMAS = {
    "ExecutionEvidencePacket": (
        ...
        "design_contradiction_state", "identity_canonicalization_version",
        "collaboration_session_id", "cross_layer_contract_hash",
        "cross_layer_contract_revision", "tracked_patch_hash", "staged_patch_hash",
        "untracked_file_manifest", "added_blob_hashes", "artifact_lifecycle_records",
        "specialist_reentry_completed", "open_invalidation_events",
        "evidence_producer", "evidence_timestamp", "freshness_reference",
    ),
