...
* **Project Context Completeness Validator**: Validates the presence of required fields in `PROJECT_CONTEXT.md` based on operating mode (Audit, Release, Implementation).
