...
NORMALIZED_EXPORT_PARITY_PATHS = (
    ...
    (Path("skills/cloak/SKILL.md"), Path("adapters/codex/skills/cloak/SKILL.md")),
    (Path("skills/clockwork/SKILL.md"), Path("adapters/codex/skills/clockwork/SKILL.md")),
    ...
    (Path("skills/ponytail/SKILL.md"), Path("adapters/codex/skills/ponytail/SKILL.md")),
