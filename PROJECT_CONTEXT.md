...
## Current Stage
v1.8.0 - Governed Execution, Registry Optimization & Reference Intelligence (`RELEASE_CANDIDATE_NOT_PUBLISHED`). The candidate is prepared from signed canonical CUIR-6 baseline `2f11f17742e68560d2a435bcab3f247b52d351ab`, tree `0f114c13d8f5f54ee5ecf1e9deb156ae6fe6e24b`, and remains subject to exact-head qualification, zero unresolved review threads, signed materialization, signed-head validation, canonical tree/signature/parent verification, and explicit final-review approval. The latest published release remains immutable `v1.7.0` at signed commit `e5305ef3e160209a0345bd2c7843c923940e62c5`; no `v1.8.0` tag or GitHub Release has been created, and publication is not authorized by the candidate.
